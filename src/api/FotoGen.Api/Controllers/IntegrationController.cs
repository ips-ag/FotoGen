...
namespace FotoGen.Controllers
{
    ...
    public class IntegrationController : ControllerBase
    {
        ...
        {
            //TODO: Get from jwt
            string userId = "e8f678ce-1087-4411-a887-6fa6622e1a42";
        ...
        public async Task<IActionResult> TrainModelAsync(TrainModelRequest request)
        {
            ...
            //TODO: Request validation
            var command = new TrainModelCommand { ModelName = userId, UserName = userName, UserEmail = email, InputImageUrl = request.ImageUrl };
            var result = await _mediator.Send(command);
            return result.ToActionResult();
        }
    }
