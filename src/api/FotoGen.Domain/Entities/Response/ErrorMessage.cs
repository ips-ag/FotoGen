...
public class ErrorMessage
{
    private static readonly Dictionary<ErrorCode, string> _errors = new()
    {
        ...
        { ErrorCode.ReachTrainingLimitation, $"{ConstValue.LimitTrainingUsageInDay}" },
        { ErrorCode.ReachPhotoGenerationLimitation, $"{ConstValue.LimitPhotoGenerationUsageInDay}" }
    };
